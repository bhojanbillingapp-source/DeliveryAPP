...
// per-restaurant deployment model — set OUTLET_ID to that restaurant's
// bbs.clients.client_id before building for a given outlet.
export const OUTLET_ID = '1bf6e162-b644-4b9b-8ea7-e7297eabb4e3';
